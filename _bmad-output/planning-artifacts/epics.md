...
- **FR25** [MVP] **Conectores tipados** (2026-09-25, estilo fluidos do Factorio): em nós de produção (Extrator, Fornalha, Montadora, Gerador, Laboratório), cada **entrada** é dedicada a **um ingrediente** da receita, marcada com ícone e cor do item, e o número de entradas vem da receita. **As saídas continuam genéricas** por enquanto (tipar as saídas fica em aberto até testar). Uma aresta só liga um conector se leva aquele item, e ao arrastar os conectores compatíveis acendem. Núcleo, Caixa, Estação, Divisor e Mesclador continuam genéricos. Trocar a receita desliga as arestas incompatíveis, devolvendo custo e itens ao Núcleo, com aviso antes de confirmar.
...
- **FR54** [MVP] Comprimento máximo: 200 células em todos os níveis. Comprimento = soma dos segmentos da polilinha, arredondada para cima. Custo por célula dobra a cada 12 células; vazão efetiva = vazão do nível × 0,5^⌊L/12⌋ (playtest 2026-09-25).
